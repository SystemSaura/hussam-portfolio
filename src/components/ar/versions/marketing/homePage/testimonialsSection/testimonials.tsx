      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          <div className="inline-flex items-center bg-blue-50 rounded-full px-3 sm:px-4 py-2 mb-4 flex-wrap justify-center gap-1 sm:gap-0">
            ...
            <span className={styles.flechaProjectsText + " arabic-body"}>٤٠+ مشروع</span>
          </div>
          ...
          <p className={styles.flechaTestimonialDescription + " max-w-2xl mx-auto px-4 sm:px-0 arabic-body"}>
            هذا ما يقوله عملاؤنا عنّا (قابل للتحقق)
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>تسويق رقمي متكامل</div>
            </div>
            
            <blockquote className={styles.testimonialQuoteV2 + " arabic-body"}>
              "كاتب موهوب، متحمس، ومتحفز، يبذل جهداً إضافياً لتقديم عمل ممتاز. سأعمل معه مرة أخرى."
            </blockquote>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>تطوير العلامة التجارية</div>
            </div>
            ...
            <div className={styles.testimonialFooterV2}>
              <div className={styles.clientInfoV2}>
                ...
                <div>
                  <div className={styles.clientNameV2 + " arabic-body"}>شاهد رؤوفي</div>
                  <div className={styles.clientCompanyV2}>امباير ريل استيت</div>
                  <div className={styles.clientLocationV2 + " arabic-body"}>🇶🇦 قطر</div>
                </div>
              </div>
              <div className={styles.companyLogoV2}>
                <img src="/logos/empirerealestate.webp" alt="امباير ريل استيت" className="h-6 sm:h-8 w-auto object-contain" />
              </div>
            </div>
          </div>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>استراتيجية المحتوى</div>
            </div>
            
            <blockquote className={styles.testimonialQuoteV2 + " arabic-body"}>
              "رائع في التعامل معه. تواصل ممتاز ومهارات عالية. قدم أكثر مما طُلب منه للحصول على أفضل جودة."
            </blockquote>
              ...
              <div className={styles.clientInfoV2}>
                <div className={styles.clientPhotoV2}>
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-100 rounded-full flex items-center justify-center">
                    <span className="text-blue-600 font-semibold text-xs sm:text-sm">آية</span>
                  </div>
                </div>
                <div>
                  <div className={styles.clientNameV2 + " arabic-body"}>آية بدر</div>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>كتابة الملف التجاري</div>
            </div>
              ...
              <div className={styles.clientInfoV2}>
                <div className={styles.clientPhotoV2}>
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-green-100 rounded-full flex items-center justify-center">
                    <span className="text-green-600 font-semibold text-xs sm:text-sm">محمد</span>
                  </div>
                </div>
                <div>
                  <div className={styles.clientNameV2 + " arabic-body"}>محمد العويس</div>
                  <div className={styles.clientCompanyV2}>راسيا</div>
                  <div className={styles.clientLocationV2 + " arabic-body"}>🇸🇦 المملكة العربية السعودية</div>
                </div>
              </div>
              <div className={styles.companyLogoV2}>
                <div className="text-gray-400 text-xs sm:text-sm font-semibold arabic-body">راسيا</div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>كتابة إبداعية</div>
            </div>
            
            <blockquote className={styles.testimonialQuoteV2 + " arabic-body"}>
              "العمل مع حسام كان مريحاً. فهم ما هو مطلوب، وسلم قبل الموعد النهائي وشعرت وكأنه جزء من الفريق."
            </blockquote>
              ...
              <div className={styles.clientInfoV2}>
                <div className={styles.clientPhotoV2}>
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-purple-100 rounded-full flex items-center justify-center">
                    <span className="text-purple-600 font-semibold text-xs sm:text-sm">جوهرة</span>
                  </div>
                </div>
                <div>
                  <div className={styles.clientNameV2 + " arabic-body"}>جوهرة التويجري</div>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>استشارات تسويقية</div>
            </div>
            
            <blockquote className={styles.testimonialQuoteV2 + " arabic-body"}>
              "مهني جداً، تسليم في الوقت المحدد، تواصل مثالي. بشكل عام أنصح به بشدة."
            </blockquote>
              ...
              <div className={styles.clientInfoV2}>
                <div className={styles.clientPhotoV2}>
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-pink-100 rounded-full flex items-center justify-center">
                    <span className="text-pink-600 font-semibold text-xs sm:text-sm">أسماء</span>
                  </div>
                </div>
                <div>
                  <div className={styles.clientNameV2 + " arabic-body"}>أسماء رجوب</div>
                  <div className={styles.clientCompanyV2}>مستشارة</div>
                  <div className={styles.clientLocationV2 + " arabic-body"}>🇸🇦 المملكة العربية السعودية</div>
                </div>
              </div>
              <div className={styles.companyLogoV2}>
                <div className="text-gray-400 text-xs sm:text-sm font-semibold arabic-body">استشارات</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="inline-flex items-center bg-gray-50 rounded-full px-4 sm:px-6 py-3 border gap-4">
            ...
            <span className={styles.flechaVerificationText + " text-center arabic-body"}>جميع التقييمات موثقة في </span>
            <img src="/logos/upwork-logo.svg" alt="Upwork" style={{ height: '16px', display: 'inline-block', verticalAlign: 'middle' }} />
            <span className={styles.flechaVerificationText + " arabic-body"}> Upwork</span>
