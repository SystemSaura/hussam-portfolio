      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className={styles.flechaTestimonialDescription + " max-w-2xl mx-auto px-4 sm:px-0 arabic-body"}>
            آراء حقيقية من عملاء جربوا نتائج قابلة للقياس من العمل التسويقي الاستراتيجي.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>التسويق عبر وسائل التواصل الاجتماعي</div>
            </div>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>تسويق المحتوى</div>
            </div>
            
            <blockquote className={styles.testimonialQuoteV2 + " arabic-body"}>
              "عمل عالي الجودة، تواصل ممتاز، يلتزم بكل موعد نهائي. كان التعاون معه متعة حقيقية."
            </blockquote>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>التسويق عبر البريد الإلكتروني</div>
            </div>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>تسويق العلامة التجارية</div>
            </div>
            
            <blockquote className={styles.testimonialQuoteV2 + " arabic-body"}>
              "عمل جيد في كتابة الملف التجاري. تواصل ممتاز، التزام بالمواعيد، ومهارات قوية طوال المشروع."
            </blockquote>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>التسويق الإبداعي</div>
            </div>
            
            <blockquote className={styles.testimonialQuoteV2 + " arabic-body"}>
              "العمل مع حسام كان مريحاً. فهم ما هو مطلوب، وسلّم قبل الموعد النهائي وشعرت وكأنه جزء من الفريق."
            </blockquote>
          ...
          <div className={styles.testimonialCardV2}>
            <div className={styles.testimonialHeaderV2}>
              ...
              <div className={styles.projectType + " arabic-body"}>التسويق الرقمي</div>
            </div>
            ...
            <div className={styles.testimonialFooterV2}>
              ...
              <div className={styles.companyLogoV2}>
                <div className="text-gray-400 text-xs sm:text-sm font-semibold arabic-body">مستشارة</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mt-8 sm:mt-12">
          <div className="inline-flex items-center bg-gray-50 rounded-full px-4 sm:px-6 py-3 border gap-4">
            ...
            <a href="https://www.upwork.com/freelancers/~01630436400e1bdae3" target="_blank" rel="noopener noreferrer" className={styles.flechaViewAllText + " hover:text-blue-800 transition-colors"}>شاهد الكل ←</a>
          </div>
        </div>
      </div>
    </section>
